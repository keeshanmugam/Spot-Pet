...
const Home = () => {
  ...
  return (
    <div>
      <img
        style={{ width: 150, heigth: 80, paddingTop:65, paddingLeft:650 }}
        src={"https://media.giphy.com/media/6JLt2OzOmEs5VxMvOe/giphy.gif"}
        alt="logo1"
      />
          ...
          <FadeIn>
            ...
            >
              ...
              <div style={{ position: "relative", top: -50, color: "black" }}>
                ...
                >
                 Upload your pet's profile to find it and let SPOT PET assist you in reuniting with your pet.
                </p>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeInRight>
            ...
            >
              ...
              <div style={{ position: "relative", top: -50, color: "black" }}>
                ...
                >
                 If you notice an abandoned animal on the street, please let us know so we can assist it!
                </p>
              </div>
            </div>
          </FadeInRight>
        ...
        <Link className={classes.linksStyle} to="/inSave">
          ...
          <FadeIn>
            ...
            >
              ...
              />
              <div style={{ position: "relative", top: -50, color: "black" }}>
                <h2 style={{}}>Share Your Stories</h2>
                <p style={{ fontSize: 18, fontStyle: "italics", marginTop: 15 }}>
                Please share your story if you've used the SPOT PET to save your pet; we'd love to hear how your life has transformed!
                </p>
              </div>
            </div>
          </FadeIn>
